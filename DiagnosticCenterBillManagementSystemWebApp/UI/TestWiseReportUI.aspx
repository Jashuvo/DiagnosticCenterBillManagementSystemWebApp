<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestWiseReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemWebApp.UI.TestWiseReportUI" EnableEventValidation="false" %>
    ...
    <form id="form2" runat="server">
        <div class="wrapper">
            ...
            <div class="main">
                ...
                <asp:GridView ID="testWiseReportGridView" runat="server" AutoGenerateColumns="False" Width="100%">
                    <Columns>
