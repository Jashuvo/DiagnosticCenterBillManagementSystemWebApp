...
namespace DiagnosticCenterBillManagementSystemWebApp.UI
{
    public partial class UnpaidBillUI : System.Web.UI.Page
    {
        ...
        protected void showButton_Click(object sender, EventArgs e)
        {
            ...
            List<TestRequestEntry> listOfUnpaidPatients = testRequestEntryManager.GetUnpaidPatients(fromDate, toDate);
            foreach (TestRequestEntry test in listOfUnpaidPatients)
            {
                finalAmount += test.TotalFee;
            }
            unpaidBillGridView.DataSource = listOfUnpaidPatients;
        ...
        protected void generatePDFButton_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=UnpaidBillReportReportFom" + fromDate + "To" + toDate + ".pdf");
            Response.Cache.SetCacheability(HttpCacheability.NoCache);
            StringWriter stringWriter = new StringWriter();
            HtmlTextWriter htmlTextWriter = new HtmlTextWriter(stringWriter);
            unpaidBillGridView.RenderControl(htmlTextWriter);
            unpaidBillGridView.HeaderRow.Style.Add("width", "15%");
            unpaidBillGridView.HeaderRow.Style.Add("font-size", "14px");
            unpaidBillGridView.Style.Add("text-decoration", "none");
            unpaidBillGridView.Style.Add("font-family", "Arial, Helvetica, sans-serif");
            unpaidBillGridView.Style.Add("font-size", "8px");
            ...
            Response.End();
            unpaidBillGridView.AllowPaging = true;
            unpaidBillGridView.DataBind();
